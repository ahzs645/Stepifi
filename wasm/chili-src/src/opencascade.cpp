...
EMSCRIPTEN_BINDINGS(opencascade)
{
    ...
    class_<Geom_BSplineCurve, base<Geom_BoundedCurve>>("Geom_BSplineCurve")
        .constructor<const TColgp_Array1OfPnt&, const TColStd_Array1OfReal&, const TColStd_Array1OfInteger&, int, bool>()
        .constructor<const TColgp_Array1OfPnt&, const TColStd_Array1OfReal&, const TColStd_Array1OfReal&, const TColStd_Array1OfInteger&, int, bool>()
    ...
    class_<Geom_OffsetSurface, base<Geom_Surface>>("Geom_OffsetSurface")
        .constructor<const Handle(Geom_Surface)&, double, bool>()
    ...
    class_<Geom_BSplineSurface, base<Geom_Surface>>("Geom_BSplineSurface")
        .constructor<const TColgp_Array2OfPnt&, const TColStd_Array1OfReal&, const TColStd_Array1OfReal&, const TColStd_Array1OfInteger&, const TColStd_Array1OfInteger&, int, int, bool, bool>()
        .constructor<const TColgp_Array2OfPnt&, const TColStd_Array2OfReal&, const TColStd_Array1OfReal&, const TColStd_Array1OfReal&, const TColStd_Array1OfInteger&, const TColStd_Array1OfInteger&, int, int, bool, bool>();
    ...
    class_<Geom_SurfaceOfRevolution, base<Geom_SweptSurface>>("Geom_SurfaceOfRevolution")
        .constructor<const Handle(Geom_Curve)&, const gp_Ax1&>()
    ...
    REGISTER_HANDLE(Geom2d_Curve);
    REGISTER_HANDLE(TColgp_HArray1OfPnt);

    // 2D geometry classes
    class_<Geom2d_Geometry, base<Standard_Transient>>("Geom2d_Geometry");

    class_<Geom2d_Curve, base<Geom2d_Geometry>>("Geom2d_Curve")
        .function("reverse", &Geom2d_Curve::Reverse);

    class_<Geom2d_BSplineCurve, base<Geom2d_Curve>>("Geom2d_BSplineCurve")
        .constructor<const TColgp_Array1OfPnt2d&, const TColStd_Array1OfReal&, const TColStd_Array1OfInteger&, int, bool>()
        .constructor<const TColgp_Array1OfPnt2d&, const TColStd_Array1OfReal&, const TColStd_Array1OfReal&, const TColStd_Array1OfInteger&, int, bool>();

    // 2D point for pcurves
    class_<gp_Pnt2d>("gp_Pnt2d")
        .constructor<double, double>()
        .property("x", &gp_Pnt2d::X)
        .property("y", &gp_Pnt2d::Y);
    ...
    // 2D point array for pcurve poles
    class_<TColgp_Array1OfPnt2d>("TColgp_Array1OfPnt2d")
        .constructor<int, int>()
        .function("value", select_overload<const gp_Pnt2d&(Standard_Integer) const>(&TColgp_Array1OfPnt2d::Value))
        .function("setValue", select_overload<void(Standard_Integer, const gp_Pnt2d&)>(&TColgp_Array1OfPnt2d::SetValue))
        .function("length", &TColgp_Array1OfPnt2d::Length);

    // 2D array of 3D points (for surface poles)
    class_<TColgp_Array2OfPnt>("TColgp_Array2OfPnt")
        .constructor<int, int, int, int>()
        .function("value", select_overload<const gp_Pnt&(Standard_Integer, Standard_Integer) const>(&TColgp_Array2OfPnt::Value))
        .function("setValue", select_overload<void(Standard_Integer, Standard_Integer, const gp_Pnt&)>(&TColgp_Array2OfPnt::SetValue));

    // Handled array for interpolation
    class_<TColgp_HArray1OfPnt>("TColgp_HArray1OfPnt")
        .constructor<int, int>()
        .function("value", &TColgp_HArray1OfPnt::Value)
        .function("setValue", select_overload<void(Standard_Integer, const gp_Pnt&)>(&TColgp_HArray1OfPnt::SetValue));

    // Real arrays
    class_<TColStd_Array1OfReal>("TColStd_Array1OfReal")
        .constructor<int, int>()
        .function("value", select_overload<const double&(Standard_Integer) const>(&TColStd_Array1OfReal::Value))
        .function("setValue", select_overload<void(Standard_Integer, const double&)>(&TColStd_Array1OfReal::SetValue))
        .function("length", &TColStd_Array1OfReal::Length);

    // Integer arrays
    class_<TColStd_Array1OfInteger>("TColStd_Array1OfInteger")
        .constructor<int, int>()
        .function("value", select_overload<const int&(Standard_Integer) const>(&TColStd_Array1OfInteger::Value))
        .function("setValue", select_overload<void(Standard_Integer, const int&)>(&TColStd_Array1OfInteger::SetValue))
        .function("length", &TColStd_Array1OfInteger::Length);

    // 2D real array (for surface weights)
    class_<TColStd_Array2OfReal>("TColStd_Array2OfReal")
        .constructor<int, int, int, int>()
        .function("value", select_overload<const double&(Standard_Integer, Standard_Integer) const>(&TColStd_Array2OfReal::Value))
        .function("setValue", select_overload<void(Standard_Integer, Standard_Integer, const double&)>(&TColStd_Array2OfReal::SetValue));
